...
markup_subject3 = types.InlineKeyboardButton(text='🏰Английский', callback_data='subject3')
markup_subject4 = types.InlineKeyboardButton(text='Назад⬅️', callback_data='back')
markup_subject.add(markup_subject1, markup_subject2, markup_subject3, markup_subject4)
